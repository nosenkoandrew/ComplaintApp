...
Revision ID: 2bb4df9e479b
Revises: 
Create Date: 2023-02-08 22:35:38.376117
...
def upgrade() -> None:
    ...
    sa.Column('role', sa.Enum('approver', 'admin', 'complainer', name='roletype'), server_default='complainer', nullable=False),
